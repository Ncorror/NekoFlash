...
## D037 — Проброс портов делается половинами, и вторая опирается на наблюдение (PROPOSED)
...
Замысел, порядок работы и список того, что обязан доказать прогон, — `docs/adr/0005_LOCAL_SOCKET_FORWARDING_RU.md`.
