...
|---|---|---|---|
| Файлов kt/java | 44 | 96 | 86 |
| Строк кода всего | 17 274 | 18 283 | 15 635 |
| из них тестов | **0** | 4 399 (~24%, 7 файлов) | 6 562 (~42%, 35 файлов) |
| Крупнейший файл | `MainActivity.kt` — 3880 строк | `UsbSessionCoordinator.kt` — 2495 строк | `AdbHandshake.kt` — 449 строк |
...
Колонка «сейчас» — снимок на **2026-09-08**, и она устаревает при каждом
...
до 42 %, а её крупнейший файл в восемь раз меньше крупнейшего файла Legacy.
