...
| Diagnostics | A2/current source/tests + Phase 2 hardware run | Structured evidence first; deterministic multi-file ZIP plus text fallback; manifest and explicit sections only; redact secrets in shareable bundles |
