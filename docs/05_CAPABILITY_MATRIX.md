...
| Diagnostics | A2/current source/tests + Phase 2 hardware run | Structured evidence first; full save/share export available; redact secrets in shareable bundles |
