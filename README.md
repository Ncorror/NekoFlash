...
Активная версия: `6.0.0-alpha3-nekoflash` (`215`). Локальные static/pure-проверки являются обязательными, а Android lint/assemble и аппаратные сценарии подтверждаются отдельно через CI и устройство.
