...
**Проверить на устройстве:** удаётся ли захват на реальном target, освобождается ли интерфейс, что происходит при отключении кабеля во время удержания, и не мешает ли захват другим инструментам.
