...
Наблюдение построено на слушателе, а не на `Flow`. Зависимость на корутины появится вместе с транспортным вводом-выводом, где она действительно нужна, и будет подтверждена сборкой в тот же момент; вводить непроверяемую зависимость раньше нечестно по отношению к CI.
