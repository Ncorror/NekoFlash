...
- CI artifact publication is enabled only to expose `app-debug.apk` for the remaining Welcome visual verification; it does not constitute hardware evidence by itself.
