...
class DiagnosticSessionTracker(
    ...
    fun recordCompact(message: String, classification: DiagnosticLogPolicy.Classification) {
        ...
        when (classification.level) {
            ...
            DiagnosticLogPolicy.Level.SUCCESS -> successCount += 1
    ...
    companion object {
        fun toJson(snapshot: Snapshot): String {
            ...
            return buildString {
                appendLine("{")
                appendLine("  \"schema\": \"ru.forum.adbfastboottool.diagnostic-session.v4\",")
                ...
                appendLine("    \"success\": ${snapshot.successCount},")
